...
namespace SLIDDES.Modular.Editor
{
    ...
    public class EditorEventListenerSByte : EditorEventListener<sbyte>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(selectedType.eventCondition != EventListenerSByte.EventCondition.none)
        ...
        {
            selected.Event = (Event<sbyte>)EditorGUILayout.ObjectField(new GUIContent("Event", "The event to listen for"), selected.Event, typeof(SByteEvent), false);
        }
    }
}
