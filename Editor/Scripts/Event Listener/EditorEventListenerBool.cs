...
namespace SLIDDES.Modular.Editor
{
    ...
    public class EditorEventListenerBool : EditorEventListener<bool>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(selectedType.eventCondition != EventListenerBool.EventCondition.none)
        ...
        {
            selected.Event = (Event<bool>)EditorGUILayout.ObjectField(new GUIContent("Event", "The event to listen for"), selected.Event, typeof(BoolEvent), false);
        }
    }
}
