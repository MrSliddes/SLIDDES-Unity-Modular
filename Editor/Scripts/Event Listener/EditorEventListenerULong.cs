...
namespace SLIDDES.Modular.Editor
{
    ...
    public class EditorEventListenerULong : EditorEventListener<ulong>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(selectedType.eventCondition != EventListenerULong.EventCondition.none)
        ...
        {
            selected.Event = (Event<ulong>)EditorGUILayout.ObjectField(new GUIContent("Event", "The event to listen for"), selected.Event, typeof(ULongEvent), false);
        }
    }
}
