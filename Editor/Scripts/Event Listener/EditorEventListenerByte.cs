...
namespace SLIDDES.Modular.Editor
{
    ...
    public class EditorEventListenerByte : EditorEventListener<byte>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(selectedType.eventCondition != EventListenerByte.EventCondition.none)
        ...
        {
            selected.Event = (Event<byte>)EditorGUILayout.ObjectField(new GUIContent("Event", "The event to listen for"), selected.Event, typeof(ByteEvent), false);
        }
    }
}
