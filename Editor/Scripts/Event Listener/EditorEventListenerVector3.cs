...
namespace SLIDDES.Modular.Editor
{
    ...
    public class EditorEventListenerVector3 : EditorEventListener<Vector3>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(selectedType.eventCondition != EventListenerVector3.EventCondition.none)
        ...
        {
            selected.Event = (Event<Vector3>)EditorGUILayout.ObjectField(new GUIContent("Event", "The event to listen for"), selected.Event, typeof(Vector3Event), false);
        }
    }
}
