...
namespace SLIDDES.Modular.Editor
{
    ...
    public class EditorEventListenerUInt : EditorEventListener<uint>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(selectedType.eventCondition != EventListenerUInt.EventCondition.none)
        ...
        {
            selected.Event = (Event<uint>)EditorGUILayout.ObjectField(new GUIContent("Event", "The event to listen for"), selected.Event, typeof(UIntEvent), false);
        }
    }
}
