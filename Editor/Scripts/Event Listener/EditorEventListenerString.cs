...
namespace SLIDDES.Modular.Editor
{
    ...
    public class EditorEventListenerString : EditorEventListener<string>
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if(selectedType.eventCondition != EventListenerString.EventCondition.none)
        ...
        {
            selected.Event = (Event<string>)EditorGUILayout.ObjectField(new GUIContent("Event", "The event to listen for"), selected.Event, typeof(StringEvent), false);
        }
    }
}
