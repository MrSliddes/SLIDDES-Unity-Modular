...
namespace SLIDDES.Modular
{
    ...
    public class EventListenerDecimal : EventListener<decimal>
    {
        ...
        public DecimalSerializable compareValue;

        public override void Invoke(decimal value)
        {
            bool passed = false;
            switch(eventCondition)
            {
                ...
                case EventCondition.greaterThen: passed = value > compareValue.value; break;
                case EventCondition.lesserThen: passed = value < compareValue.value; break;
                case EventCondition.greaterOrEqual: passed = value >= compareValue.value; break;
                case EventCondition.lesserOrEqual: passed = value <= compareValue.value; break;
                default: break;
            }
            if(!passed) return;
