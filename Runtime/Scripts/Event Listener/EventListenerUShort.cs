...
{
    [AddComponentMenu("SLIDDES/Modular/Event Listeners/Event Listener UShort")]
    public class EventListenerUShort : EventListener<ushort>
    {
        ...
        public override void Invoke(ushort value)
        {
            bool passed = false;
